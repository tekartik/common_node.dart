...
extension JsFsFileHandleExt on JsFsFileHandle {
  ...
  /// storage device. The specific implementation is operating system and device
  /// specific. Refer to the POSIX fsync(2) documentation for more detail.
  external js.JSPromise sync();
}
